...
class TuiOld(controller: Controller) extends Observer{
  controller.add(this)
  ...
  def evaluateSettings(inputStr: String): Int = {
    ...
    input match {
      case 2 => controller.initPlayers(2)
      case 3 => controller.initPlayers(3)
      case 4 => controller.initPlayers(4)
      case 5 => controller.initPlayers(5)
      case 6 => controller.initPlayers(6)
      case 7 => controller.initPlayers(7)
