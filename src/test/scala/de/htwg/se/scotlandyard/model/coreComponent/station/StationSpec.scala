...
class StationSpec extends WordSpec with Matchers {
  "Station" should {
    "new Station" in {
      ...
      the [Exception] thrownBy station.setNeighbourBuses(Set()) should have message "Taxi stations can't have Bus neighbours"
      the [Exception] thrownBy station.setNeighbourUndergrounds(Set()) should have message "Bus or Taxi stations can't have Underground neighbours"
