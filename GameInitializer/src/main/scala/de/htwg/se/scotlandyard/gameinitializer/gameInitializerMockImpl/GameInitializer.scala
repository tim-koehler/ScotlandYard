...
class GameInitializer() extends GameInitializerInterface{
  ...
  override def initialize(nPlayers: Int, stationsSource: String): GameModel = {
    ...
    var station2 = Station(2, StationType.Taxi, blackStation = false, Set(station1), Set(), Set())
    val station3 = Station(3, StationType.Taxi, blackStation = false, Set(station1), Set(), Set())
    val station4 = Station(4, StationType.Bus, blackStation = false, Set(station1), Set(), Set())
    var station5 = Station(5, StationType.Underground, blackStation = false, Set(station1, station2), Set(), Set())
